...
RH_RF95::RH_RF95(uint8_t slaveSelectPin, uint8_t interruptPin)
    : RHSPIDriver(slaveSelectPin), _rxBufValid(0)
{
}
...
bool RH_RF95::waitPacketSent()
{
    ...
    {
        // Do some useful work, yield() analog here
    }
...
bool RH_RF95::isChannelActive()
{
    if (_mode != RHModeCad)
    {
        ...
        spiWrite(RH_RF95_REG_40_DIO_MAPPING1, 0x80);
        _mode = RHModeCad;
    }
